 ...
 * @author Asih
 */
public class Convergence_HeadcountPerNodePerTime extends Report implements UpdateListener {
    ...
    private List<Double> listInterval = new ArrayList<>();
    private Map<DTNHost, ArrayList<Integer>> counitngArry = new HashMap<DTNHost, ArrayList<Integer>>();

    public Convergence_HeadcountPerNodePerTime() {
        super();
