...
abstract public class NetworkInterface implements ModuleCommunicationListener {
    ...
    /**
     * Activeness offset jitter -setting id ({@value}) The maximum amount of
     * random offset for the offset
     */
    ...
    //public static final String ACTIVE_TIME = "isActiveTimecoba"; //Tambahan
...
//    private ActivenessKu coba; //Tambahan
...
//        this.coba = (ActivenessKu) s.createIntializedObject(s.getSetting(ACTIVE_TIME)); //Tambahan
...
//        this.coba = ni.coba; //Tambahan
 ...
 /* TODO: support for multiple interfaces */
    ...
    public boolean isActive() {
        boolean active;
//        coba.isActive(); //Tambahan
        if (ah == null) {
            return true;
            /* no handler: always active */
        }
 ...
 /* no battery -> inactive */
    ...
    /**
     * Connects this host to another host. The derived class should check that
     * all pre-requisites for making a connection are satisfied before actually
     * connecting.
     *
    ...
    /**
     * Disconnects this host from another host. The derived class should make
     * the decision whether to disconnect or not
     *
    ...
    /**
     * Removes a connection by its position (index) in the connections array of
     * the interface
     *
