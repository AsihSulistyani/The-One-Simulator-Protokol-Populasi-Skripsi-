 ...
 * @author Asih
 */
public class IsActive implements ActivenessKu {

    /**
     * <P>
     * Active times -setting id ({@value})</P>
     * <P>
     * Syntax: <CODE>start, end</CODE></P>
     * <P>
     * Defines the simulation time ranges when the node is active. Multiple
     * timer ranges can be concatenated by repeating the sequence. Time limits
     * must be in order and must not overlap.</P>
     * <P>
     * Example: 100,200,6000,6500<BR>
    ...
    /**
     * <P>
     * Active periods -setting id ({@value}).</P>
     * <P>
     * Syntax: <CODE>activeTime, inactiveTime</CODE></P>
     * <P>
     * Defines the activity and inactivity periods. </P>
     * <P>
     * Example: 2000,500<BR>
    ...
    /**
     * <P>
     * Active periods offset -setting id ({@value}).</P>
     * <P>
     * Defines how much the activity periods are offset from sim time 0. Value X
     * means that the first period has been on for X seconds at sim time 0.
     * Default = 0 (i.e., first active period starts at 0) </P>
     */
    ...
    public IsActive(IsActive proto) {
        this.activeTimes = proto.activeTimes;
    }

    public IsActive(Settings s) {
     ...
     */
    /**
     * Returns true if node should be active after/before offset amount of time
     * from now
     *
